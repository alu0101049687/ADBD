...
INSERT INTO `mydb`.`Empleado` (`dni`, `antiguedad`, `css`, `sueldo`, `zona.nombre`, `vivero.coordenadas`, `fecha_inicial`, `fecha_fin`, `ventas`) VALUES (DEFAULT, NULL, NULL, NULL, NULL, NULL, DEFAULT, NULL, NULL);
...
DELIMITER $$
DROP TRIGGER IF EXISTS insertar_sueldo$$
CREATE TRIGGER insertar_sueldo
    BEFORE INSERT ON empleado FOR EACH ROW
    BEGIN
        IF NEW.sueldo  IS NULL THEN
            SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = "Sueldo incorrecto";
        END IF;
    END$$
